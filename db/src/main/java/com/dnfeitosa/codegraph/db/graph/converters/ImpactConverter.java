...
public class ImpactConverter {
	...
	private com.dnfeitosa.codegraph.model.Module toModule(com.dnfeitosa.codegraph.db.graph.nodes.Module impactor) {
		return new com.dnfeitosa.codegraph.model.Module(impactor.getName());
	}
}